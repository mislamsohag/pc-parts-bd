    ...
    return (
        <div>
            ...
            <div className='col-lg-6 col-sm-12 g-5 p-2 border'>
                ...
                <div className='col-lg-6 col-md-6 col-sm-12 g-3 p-2'>
                    <p className=' text-xl'> This can be a tricky question, and you’ll probably need to defend your answer with follow-up Q&A, so pay special attention to learning the differences, and how to apply the knowledge to write better code.</p>
                    <br />
                    <p className=' text-xl'>Class Inheritance: A class is like a blueprint — a description of the object to be created. Classes inherit from classes and create subclass relationships: hierarchical class taxonomies.</p>
                </div>
            </div>
